...
// PART 1:
var API_KEY = '9ed6b1a68054d3d77996ac0609555ce2'
var URL = 'http://api.openweathermap.org/data/2.5/weather?q=new+york,us&units=imperial&APPID=9ed6b1a68054d3d77996ac0609555ce2'
...
function handleSuccess(response) {
  // console log prints the response coming back into browser to see within console
  // console.log(response)
  $('#nyc-weather').append(response.main.temp + ' ' + response.main.humidity + ' ' +response.wind.speed)

  if (response.main.temp > 70) {
    $('body').css('background', 'yellow')
  } else {
    $('body').css('background', 'url(https://nyoobserver.files.wordpress.com/2014/11/457792700.jpg?quality=80&w=1270&h=846)')
  }
