...
//function addNewItem() {
	// console.log('test') to work way through code checking each value is passing w/o errors
	// 1. grab value of input from HTML
	//var newItem = document.querySelector('#new-item').value
	// Bonus q's
	//	if (newItem === "") {
	//		return alert('Add Item')
	//	} else {
	// 2. create a new <l1> element 
	//		var newListItem = document.createElement('li')
	// 3. set the new element;s innerHTML to user's new item
	//		newListItem.innerHTML = newItem
...
$('#add-item').click(function (addNewItem) {
